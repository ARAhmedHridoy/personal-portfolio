            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('admin/experience/update/'.$get_data->id)}}">
                            @csrf
                            <div class="card-body">
                                <div class="fron-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="experience_name" value="{{ $get_data->experience_name }}" placeholder="Enter Experience Name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="fron-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="company_name" value="{{ $get_data->company_name }}"  placeholder="Enter Company Name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="fron-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="year" value="{{ $get_data->year }}"  placeholder="2020-2024" maxlength="11" required>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
