            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('admin/service/post') }}">
                            @csrf
                            <div class="card-body">
                                <div class="fron-group row">
                                    <label class="col-sm-2 col-form-label" for="icon">Icon<span class="text-danger">*</span> :</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="icon"  placeholder="fa-laptop" required>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="fron-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="url" class="form-control" name="link"  placeholder="Enter read more Link">
                                    </div>
                                </div>
                            </div>
